      ...
      <div className="flex flex-col">
        <CardTitle className="flex items-center justify-between">
          <span className="text-2xl font-bold">
            <ColoredText>Bienvenue dans TaxHacker 👋</ColoredText>
          </span>
          <Button
            variant="outline"
            size="icon"
        ...
        <CardDescription className="mt-5">
          <p className="mb-3">
            Je suis une petite application de comptabilité qui vous aide à gérer les reçus, chèques et factures sans fin avec l'IA. Voici ce que je peux faire :
          </p>
        ...
        <div className="mt-2">
          <Link href="https://github.com/TaxHacker/TaxHacker" className="text-blue-500 hover:underline">
            Code Source
          </Link>
          <span className="mx-2">|</span>
          <Link href="https://github.com/TaxHacker/TaxHacker/issues" className="text-blue-500 hover:underline">
          ...
          <span className="mx-2">|</span>
          <Link href="mailto:support@taxhacker.local" className="text-blue-500 hover:underline">
            Nous Contacter
          </Link>
        </div>
