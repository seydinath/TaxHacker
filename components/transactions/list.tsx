...
export function TransactionList({ transactions, fields = [], categories = [], projects = [] }: { transactions: Transaction[]; fields?: Field[]; categories?: Category[]; projects?: Project[] }) {
  ...
  return (
    <div className="rounded-md border">
      ...
      {selectedIds.length > 0 && (
        <BulkActionsMenu selectedIds={selectedIds} categories={categories} projects={projects} onActionComplete={() => setSelectedIds([])} />
      )}
    </div>
  )
}
