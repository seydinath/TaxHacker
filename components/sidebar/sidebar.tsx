      ...
      <Sidebar variant="inset" collapsible="icon">
        ...
        <SidebarFooter>
            ...
            <SidebarGroupContent>
              <SidebarMenu>
                ...
                {isSelfHosted && (
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild>
                      <Link href="https://github.com/TaxHacker/TaxHacker" target="_blank">
                        <Gift />
                        Soutenir le projet
                      </Link>
                    </SidebarMenuButton>
          ...
          <SidebarGroup>
            <SidebarGroupContent>
              <SidebarMenu>
                <SidebarMenuItem>                  <SidebarUser profile={profile} isSelfHosted={isSelfHosted} />
                </SidebarMenuItem>
              </SidebarMenu>
            </SidebarGroupContent>
          </SidebarGroup>
